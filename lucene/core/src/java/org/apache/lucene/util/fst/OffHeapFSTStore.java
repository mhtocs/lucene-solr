...
public final class OffHeapFSTStore implements FSTStore {
    ...
    public void init(DataInput in, long numBytes) throws IOException {
        if (in instanceof IndexInput) {
            ...
            throw new IllegalArgumentException("parameter:in should be an instance of IndexInput for using OffHeapFSTStore");
        }

        this.indexStartFP = this.in.getFilePointer();
    }
    ...
    public FST.BytesReader getReverseBytesReader() {
        return new ReverseIndexInputReader(in.clone(), indexStartFP);
    }
